...
var QuestionMarkCircle = React.forwardRef(function (_a, ref) {
    ...
    return (<svg xmlns="http://www.w3.org/2000/svg" width={15} height={15} fill="none" ref={ref} {...props}>
        <g fill={color} clipPath="url(#a)">
          ...
          <path fillRule="evenodd" d="M.305 7.5a7.194 7.194 0 1 1 14.39 0 7.194 7.194 0 0 1-14.39 0M7.5 1.806a5.694 5.694 0 1 0 0 11.389 5.694 5.694 0 0 0 0-11.39" clipRule="evenodd"/>
        </g>
        <defs>
          <clipPath id="a">
